...
const SPECS: readonly SpecTag<BeatName>[] = [
  { at: "pick", text: "Every total says how much was measured", x: 50, y: 22 },
  { at: "fill", text: "A refused request costs zero bytes", x: 50, y: 74 },
];
...
export function ByteBudgetDemo() {
  ...
  return (
    ...
    <div className="bb" ref={stageRef} data-beat={beat} data-lap={run}>
      <div className="bb-placeholder">Byte Budget</div>
      <SpecTags beats={BEATS} beat={beat} tags={SPECS} className="bb-specs" />
    </div>
  );
}
